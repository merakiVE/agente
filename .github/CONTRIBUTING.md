...
Te recomendamos nombrar los branches o ramas de tus colaboraciones para agente con el prefijo: `agen` seguido por la convención de tu preferencia. A nosotros nos agrada esta:

`<prefijo agen>-<palabra "issue">-<numero de issue>-`.

Quedaría algo como esto: `agen-issue-14-encuesta`. 
Pero también es válido algo como esto: `agen-issue-20`.

[Plantilla para issue](https://github.com/merakiVE/agente/blob/master/.github/ISSUE_TEMPLATE.md)
...
- Sigue las indicaciones dadas en la plantilla de [pulls requests](https://github.com/merakiVE/agente/blob/master/.github/PULL_REQUEST_TEMPLATE.md).
...
_Si quieres proponer un nuevo tipo de "acción", puedes abrir un `issue`, para ello en este [enlace](https://github.com/merakiVE/agente/issues)_
